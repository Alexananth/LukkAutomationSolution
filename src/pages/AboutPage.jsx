...
const AboutPage = () => {
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="bg-gradient-to-r from-secondary-accent to-hover-effect p-12 rounded-large text-center mb-12">
        <h1 className="text-4xl font-bold text-text-color">About Lukk Automation</h1>
      </div>
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        <div className="bg-soft-highlight p-8 rounded-large">
      ...
      <div className="bg-milky-white p-8 rounded-large">
